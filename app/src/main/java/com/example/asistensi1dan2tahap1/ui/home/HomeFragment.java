...
public class HomeFragment extends Fragment implements MovieItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        lstSlides.add(new Slide(R.drawable.tvone,"star wars", "https://youtu.be/2Qkifm3UYOc"));
        lstSlides.add(new Slide(R.drawable.tvrcti,"Fantastic Beasts and Where to Find Them", "https://youtu.be/JggZlRGqFbo"));
        lstSlides.add(new Slide(R.drawable.tvsctv,"X-Men: Apocalypse", "https://youtu.be/G-I9aTI0XMQ"));
        lstSlides.add(new Slide(R.drawable.tvantv,"Fantastic Beasts and Where to Find Them", "https://youtu.be/O5sXKuTCxeA"));
